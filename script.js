...
function cutChoose() {
    ...
    maviee = document.getElementById("mavie")
...
function EnterGame() {
    ...
    node = document.createTextNode("The Struggles: FR Louis XVI");
...
function start() {
    ...
    node = document.createTextNode("Don't hurt me.");
    n.appendChild(node);
    ...
    node = document.createTextNode("I can do it!");
    ba.appendChild(node);
    ...
    node = document.createTextNode("Bring it on!");
    creditss.appendChild(node);
    ...
    node = document.createTextNode("I am the ruler!");
    ...
    maviee = document.createElement('button');
    maviee.setAttribute("id", "mavie");
    maviee.setAttribute("onclick", "mavie()");
    maviee.setAttribute("onmouseover","peasantHover()")
    maviee.setAttribute("onmouseout","resetDifText()")
    node = document.createTextNode("Ma vie!");
    maviee.appendChild(node);
    ...
    titleScreen.appendChild(maviee);
...
function Death() {
    ...
    function FadingIn() {
        ...
        if (faded == true && valueFade == false) {
            ...
            node = document.createTextNode(month+" "+year+". My efforts are in vain. This country, I've put my all into it... And all that I'm left with is this. They won. He won. And now he will take over France... I gave it my all. And that's all I could do. Goodbye, cruel world... (Cannon ending)")
...
function Game() {
    ...
    function FadeIn() {
        ...
        if (opac <= 0) {
            documentHTML.style.backgroundImage = "url(\"Images/RevolutionImg1.jpg\")"
            clearInterval(introFade);
            console.log("stopped")
            faded = true
            titleScreen = document.getElementById("titleScreen");
    ...
    function FadingIn() {
        ...
        if (faded == true && valueFade == false) {
            valueFade = true
            opac = 0
            node = document.createTextNode("1790. The start of a revolution. What are the people calling for? My head. I can't fix this. I'm left to fight them on my own. I'm stripped of who I once was. ");
            introText.appendChild(node);
            introTextDiv = document.getElementById("introDiv");
            introTextDiv.appendChild(introText);
        }
    ...
    setTimeout(() => {
        ...
        function FadeIn() {
            ...
            if (opac <= 0) {
                documentHTML.style.backgroundImage = "url(\"Images/IMG2.jpg\")"
                clearInterval(introFade2);
                console.log("stopped")
                faded = true
                titleScreen = document.getElementById("titleScreen");
        ...
        function FadingIn() {
            ...
            if (faded == true && valueFade == false) {
                valueFade = true
                opac = 0
                node = document.createTextNode("I will not take this anymore. I will fight. And if I can't, I'm getting out of this hellhole.");
                introText.appendChild(node);
                introTextDiv = document.getElementById("introDiv");
                introTextDiv.appendChild(introText);
      ...
      setTimeout(() => {
        alert("Notice:\nKeep your popularity high or your people will completely overun and murder you.\nKeep supplies up or all of France will starve even more and riot!\nDefeat the rebels and crush the revolution!")
        ActualGame();
